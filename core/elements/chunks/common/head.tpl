...
<link rel="stylesheet" href="{$_modx->config.assets_url}templates/default/css/normalize.css" type="text/css" />
<link rel="stylesheet" href="{$_modx->config.assets_url}templates/default/css/slick.css" type="text/css" />
